        ...
        <div className="container">
            ...
            <div className="col-xs-3 col-md-6 chat">
                ...
                <ul className="footer-links">
                    <li><a href="https://www.linkedin.com/in/satwik-anmol-1487a3191/">Linkedin</a></li>
                    <li><a href="https://twitter.com/satwikum">Twitter</a></li>
                    <li><a href="https://github.com/Satwikan">Github</a></li>
                </ul>
            </div>
            </div>
            <hr/>
